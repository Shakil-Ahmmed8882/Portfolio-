...
export const MenuIte = ({setIsOpen, item, icon: Icon }) => {
  ...
  return (
    <li
      ...
      text-[18px] relative p-2 transition-all duration-300  z-20 hover:text-white duration-600 cursor-pointer pl-9`}
    >
      ...
      <span
        className={`${
          isItemHovered
            ? "visible opacity-100 translate-y-4 bg-primary-color"
...
<span className={`${
          isItemHovered
            ? "visible opacity-100 translate-y-0 bg-[#2c30339f] block w-full h-11 "
