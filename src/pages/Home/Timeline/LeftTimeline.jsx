export const LeftTimeline = () => {
    return (
        < >
            <div className="border-2-2 absolute border-opacity-20 border-[#d0d0d0] h-full border left-1/2"></div>
            <div className="mb-8 timeline-card relative md:flex md:justify-between  w-full right-timeline">
                ...
                <div className="z-10 md:z-20 flex items-center order-1
                    ...
                    <h1 className="mx-auto font-semibold text-lg text-white md:block hidden">3</h1>
                </div>
